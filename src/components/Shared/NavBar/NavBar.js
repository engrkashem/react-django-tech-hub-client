    ...
    const menuItems = <>
        {
            user ?
                <React.Fragment>
                    ...
                    <li>
                        <CustomActiveLink to={'/messaging'}>Chat Room</CustomActiveLink>
                    </li>
        ...
        <div className="navbar bg-base-100 border-b border-blue-50 fixed z-50">
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul tabIndex={1} className="menu menu-compact dropdown-content mt-3 p-2 shadow  rounded-box w-52 bg-base-100 font-medium">
                        {menuItems}
                    </ul>
                </div>
